...
def train_tcn(train_loader, val_loader, batch_params, hyperparameters):
    ...
    model_path = os.path.join(checkpoints_dir, f"TCN_latest_{current_datetime}.pth") 
    torch.save(model.state_dict(), model_path)
...
def train_cnnlstm(train_loader, val_loader, batch_params, hyperparameters):
    ...
    model_path = os.path.join(checkpoints_dir, f"CNN-LSTM_latest_{current_datetime}.pth") 
    torch.save(model.state_dict(), model_path)
